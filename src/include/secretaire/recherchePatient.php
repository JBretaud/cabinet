...
?>
<div id="recherche" class="container frame" style="width:100%">
    <div class="row">
        <div class="col-12 mb-4 title d-flex flex-column align-items-center">
    ...
    <div class="d-flex flex-row justify-content-center">
        <div class="d-flex flex-column align-items-center mr-2">
            ...
            <input type="text" class="form-control" name="nom" v-model="nom">
        </div>
        <div class="d-flex flex-column align-items-center">
            <label for="prenom">Prenom</label>
            <input type="text" class="form-control" name="prenom" v-model="prenom">
        </div>
    </div>
    <div class="d-flex flex-column align-items-center">
        <ul>
            ...
            <li v-for="patient in filteredPatients" class="my-2">
                <a v-bind:href="'/cabinet/<?= ($path[0]==="praticien" && $_SESSION['type']===2) ? "praticien" : "secretaire";?>/fiche?idPatient='+ patient.idPatient" class="d-flex flex-column justify-content-around align-items-center">
